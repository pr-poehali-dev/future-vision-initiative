...
const education = [
  ...
  {
    icon: "BookOpen",
    level: "Незаконченное высшее (в процессе)",
    title: "Спортивный менеджмент",
    description: "Продолжаю обучение по специальности «Спортивный менеджмент» — для углублённого понимания системы управления в спорте.",
  },
  {
    icon: "Brain",
  ...
  },
  {
    ...
    description: "Углублённая подготовка по консультированию спортсменов на всех уровнях подготовки. Московский институт психологии, 2024.",
  },
]
...
const achievements = [
  ...
  {
    icon: "Dumbbell",
    title: "8 лет тренерской работы",
    description: "Видела спорт с трёх сторон: как спортсмен, как тренер и как психолог. Знаю, что происходит внутри команды, как выстраиваются отношения тренер–спортсмен–родитель, и где чаще всего ломается психология.",
  },
  {
    icon: "Calendar",
  ...
  {
    icon: "Users",
    title: "Работа для всех участников спорта",
    description: "Помогаю не только атлетам, но и тренерам — с выгоранием, выстраиванием контакта с подопечными и родителями детей-спортсменов.",
  },
]
