        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Запишитесь на консультацию — и уже на первой встрече получите конкретные инструменты
              <br className="hidden md:block" />
              для улучшения ментальной устойчивости и спортивных результатов.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Спортсменов</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">2 МС</div>
                <div className="text-xs md:text-sm text-gray-300 font-medium">Дзюдо и самбо</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Из любой точки</div>
              </div>
            </div>
